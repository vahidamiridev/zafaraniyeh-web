        ...
        <div className="container" >
            ...
            <div className="w-full px-4 flex flex-col justify-center items-center gap-5  py-5 lg:flex-row " >
              ...
              >
                ...
                دوره های آموزشی بر اساس آخرین استاندارد های آموزشی وآزمون های بین المللی و منطبق بر نیاز های جامعه وبازار جهانی هستند. در پایان هر دوره وموفقیت درآزمون مدرک بین المللی قابل ترجمه از سازمان فنی وحرفه ایی کشور ارائه میگردد.
                </p>
