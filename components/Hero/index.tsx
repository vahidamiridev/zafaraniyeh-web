    ...
    <>
      ...
      >
        <div className="container">
          <div className="flex w-full flex-col items-center justify-center gap-5 px-4  py-5 lg:flex-row ">
            <div
              className="wow fadeInUp text-center md:max-w-[550px]"
              data-wow-delay=".2s"
            >
              ...
              <p className="mb-12 text-base !leading-relaxed text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                دوره های آموزشی بر اساس آخرین استاندارد های آموزشی وآزمون های
                بین المللی و منطبق بر نیاز های جامعه وبازار جهانی هستند. در
                پایان هر دوره وموفقیت درآزمون مدرک بین المللی قابل ترجمه از
                سازمان فنی وحرفه ایی کشور ارائه میگردد.
              </p>
